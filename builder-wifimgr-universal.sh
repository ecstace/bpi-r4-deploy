...
OPENWRT_COMMIT=${OPENWRT_COMMIT:-b6a820ea85d268ecbe55c0f803c8b2dbb811c8aa}
...
( cd mtk-openwrt-feeds && git checkout ${MTK_COMMIT:-511100a886cf99a12588ccbb810c70928a772027} )
