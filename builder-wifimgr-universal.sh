...
OPENWRT_COMMIT=${OPENWRT_COMMIT:-53846db6864e58293792f7e97ce05f4103b0c75e}
...
( cd mtk-openwrt-feeds && git checkout ${MTK_COMMIT:-71dc7daf207699bd93445c7e0c98f1a899800989} )
